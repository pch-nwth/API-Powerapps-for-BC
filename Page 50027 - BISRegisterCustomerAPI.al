page 50027 BISRegisterCustomerAPI
{
    ...
    layout
    {
        area(content)
        {
            repeater(General)
            {
                ...
                field(registerationdate; Rec."Registeration Date")
                {
                    ApplicationArea = All;
                ...
                //contact
                field(contactAddressNo; Rec."Contact Address No.")
                {
                    ApplicationArea = All;

                }
                field(contactMoo; Rec."Contact Moo")
                {
                    ApplicationArea = All;

                }
                field(contactSoi; Rec."Contact Soi")
                {
                    ApplicationArea = All;

                }
                field(contactStreet; Rec."Contact Street")
                {
                    ApplicationArea = All;

                }
                field(contactThumbon; Rec."Contact Thumbon")
                {
                    ApplicationArea = All;

                }
                field(contactAmphur; Rec."Contact Amphur")
                {
                    ApplicationArea = All;

                }
                field(contactProvince; Rec."Contact Province")
                {
                    ApplicationArea = All;
    ...
    begin
        if SalesSetup."Def. Cust. Posting" <> '' then
            Rec.custPostingGroup := SalesSetup."Def. Cust. Posting";
        if SalesSetup."Def. Gen. Bus" <> '' then
            Rec.genbus := SalesSetup."Def. Gen. Bus";
    end;
