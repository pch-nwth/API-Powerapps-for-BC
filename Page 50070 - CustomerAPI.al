    ...
    layout
    {
        area(content)
        {
            repeater(General)
            {
                ...
                field(paymenttermcode; Rec."Payment Terms Code")
                {
                    ApplicationArea = All;
                ...
                field(remaincredit; Rec."Credit Limit (LCY)" - Rec."Balance (LCY)" - Rec."Outstanding Orders (LCY)")
                {
                ...
                field(customerremark; Rec."Customer Remark")
                {
